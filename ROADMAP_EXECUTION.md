...
等待自建 Relay 提交的 PR #1 Actions 全部进入 `COMPLETED/SUCCESS`；失败则继续定位并修复。全绿后进入持续测速、可解释选路与可选 Mosh。C4 真机泄漏矩阵、Relay 真实公网/多区域/TLS-VPN 部署保持外部验收；Android Sync capability 继续 disabled。
